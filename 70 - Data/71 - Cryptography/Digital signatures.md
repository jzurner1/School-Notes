Digital signatures are one practical implementation of hashing. In essence, a digital signature is a cryptographic token that provides authentication and data verification.
