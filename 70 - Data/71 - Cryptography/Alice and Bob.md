Alice and Bob are placeholders for "Party A" and "Party B", specifically when two parties are trying to communicate, such as when Alice wants to send Bob a secure message.
